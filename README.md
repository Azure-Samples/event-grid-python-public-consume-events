...
The data plane samples in this repo are for azure-eventgrid v1 (1.x). For the samples for v2 (2.x and above) please visit [here](https://github.com/Azure/azure-sdk-for-python/tree/master/sdk/eventgrid/azure-eventgrid/samples). This repo will be archived once the v2 becomes stable.
